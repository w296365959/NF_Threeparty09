package com.bairuitech.sscf.anychat;		// 不能修改包的名称
...
{
	com.bairuitech.sscf.anychat.AnyChatBaseEvent baseEvent;
	com.bairuitech.sscf.anychat.AnyChatStateChgEvent stateChgEvent;
	com.bairuitech.sscf.anychat.AnyChatPrivateChatEvent privateChatEvent;
	AnyChatTextMsgEvent		textMsgEvent;
	com.bairuitech.sscf.anychat.AnyChatTransDataEvent transDataEvent;
	com.bairuitech.sscf.anychat.AnyChatVideoCallEvent videoCallEvent;
	AnyChatUserInfoEvent	userInfoEvent;
	AnyChatDataEncDecEvent	encdecEvent;
	com.bairuitech.sscf.anychat.AnyChatRecordEvent recordEvent;
	com.bairuitech.sscf.anychat.AnyChatObjectEvent objectEvent;
	...
	public static com.bairuitech.sscf.anychat.AnyChatCameraHelper mCameraHelper = new com.bairuitech.sscf.anychat.AnyChatCameraHelper();
	public com.bairuitech.sscf.anychat.AnyChatSensorHelper mSensorHelper = new com.bairuitech.sscf.anychat.AnyChatSensorHelper();
	public com.bairuitech.sscf.anychat.AnyChatVideoHelper mVideoHelper = new com.bairuitech.sscf.anychat.AnyChatVideoHelper();
	...
	// 设置AnyChat基本事件通知接口
	public void SetBaseEvent(com.bairuitech.sscf.anychat.AnyChatBaseEvent e)
	{
	...
	// 设置AnyChat状态变化事件通知接口
	public void SetStateChgEvent(com.bairuitech.sscf.anychat.AnyChatStateChgEvent e)
	{
		RegisterNotify();
		this.stateChgEvent = e;
	}
	// 设置AnyChat私聊消息通知接口
	public void SetPrivateChatEvent(com.bairuitech.sscf.anychat.AnyChatPrivateChatEvent e)
	{
		RegisterNotify();
	...
	// 设置数据传输消息通知接口
	public void SetTransDataEvent(com.bairuitech.sscf.anychat.AnyChatTransDataEvent e)
	{
		RegisterNotify();
		this.transDataEvent = e;
	}
	// 设置视频呼叫事件通知接口
	public void SetVideoCallEvent(com.bairuitech.sscf.anychat.AnyChatVideoCallEvent e)
	{
		RegisterNotify();
	...
	// 设置视频录制、拍照事件通知接口
	public void SetRecordSnapShotEvent(com.bairuitech.sscf.anychat.AnyChatRecordEvent e)
	{
		RegisterNotify();
		this.recordEvent = e;
	}
	// 设置业务对象事件通知接口
	public void SetObjectEvent(com.bairuitech.sscf.anychat.AnyChatObjectEvent e)
	{
		RegisterNotify();
		this.objectEvent = e;
	}
	...
	{
		return GetSDKOptionInt(com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_SO_CORESDK_MAINVERSION);
	}
	// 查询SDK从版本号
	public int GetSDKSubVersion()
	{
		return GetSDKOptionInt(com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_SO_CORESDK_SUBVERSION);
	}
	// 查询SDK编译时间
	public String GetSDKBuildTime()
	{
		return GetSDKOptionString(com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_SO_CORESDK_BUILDTIME);
	}
	...
	// 传送文件
	public native int TransFile(int userid, String filepath, int wparam, int lparam, int flags, com.bairuitech.sscf.anychat.AnyChatOutParam outParam);
	// 透明通道传送缓冲区
	public native int TransBuffer(int userid, byte[] buf, int len);
	// 透明通道传送缓冲区扩展
	public native int TransBufferEx(int userid, byte[] buf, int len, int wparam, int lparam, int flags, com.bairuitech.sscf.anychat.AnyChatOutParam outParam);
	// 终止传输任务
	public native int CancelTransTask(int userid, int taskid);
	// 查询传输任务状态
	public native int QueryTransTaskInfo(int userid, int taskid, int infoname, com.bairuitech.sscf.anychat.AnyChatOutParam outParam);
	// 发送SDK Filter 通信数据
	...
	{
		SetSDKOptionInt(com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_SO_LOCALVIDEO_FOCUSCTRL, 1);
	}
	// 查询指定用户名称
	public String GetUserName(int userid)
	{
		return QueryUserStateString(userid, com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_USERSTATE_NICKNAME);
	}
	// 查询指定用户互联网IP地址
	public String GetUserIPAddr(int userid)
	{
		return QueryUserStateString(userid, com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_USERSTATE_INTERNETIP);
	}
    ...
    public void OnNotifyMsg(int dwNotifyMsg, int wParam, int lParam)
    {
    	switch(dwNotifyMsg)
    	{
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_CONNECT:
			if(baseEvent != null)
				baseEvent.OnAnyChatConnectMessage(wParam>=1?true:false);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_LOGINSYSTEM:
			if(baseEvent != null)
				baseEvent.OnAnyChatLoginMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_ENTERROOM:
			if(baseEvent != null)
				baseEvent.OnAnyChatEnterRoomMessage(wParam, lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_USERATROOM:
			if(baseEvent != null)
				baseEvent.OnAnyChatUserAtRoomMessage(wParam,lParam>=1?true:false);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_LINKCLOSE:
			if(baseEvent != null)
				baseEvent.OnAnyChatLinkCloseMessage(lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_ONLINEUSER:
			if(baseEvent != null)
				baseEvent.OnAnyChatOnlineUserMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_MICSTATECHANGE:
			if(stateChgEvent != null)
				stateChgEvent.OnAnyChatMicStateChgMessage(wParam,lParam==0?false:true);
			break;			
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_CAMERASTATE:
			if(stateChgEvent != null)
				stateChgEvent.OnAnyChatCameraStateChgMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_CHATMODECHG:
			if(stateChgEvent != null)
				stateChgEvent.OnAnyChatChatModeChgMessage(wParam,lParam==0?true:false);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_ACTIVESTATE:
			if(stateChgEvent != null)
				stateChgEvent.OnAnyChatActiveStateChgMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_P2PCONNECTSTATE:
			if(stateChgEvent != null)
				stateChgEvent.OnAnyChatP2PConnectStateMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_VIDEOSIZECHG:
//			OnAnyChatVideoSizeChgMessage(wParam, LOWORD(lParam), HIWORD(lParam));
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_PRIVATEREQUEST:
			if(privateChatEvent != null)
				privateChatEvent.OnAnyChatPrivateRequestMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_PRIVATEECHO:
			if(privateChatEvent != null)
				privateChatEvent.OnAnyChatPrivateEchoMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_PRIVATEEXIT:
			if(privateChatEvent != null)
				privateChatEvent.OnAnyChatPrivateExitMessage(wParam,lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_USERINFOUPDATE:
			if(userInfoEvent != null)
				userInfoEvent.OnAnyChatUserInfoUpdate(wParam, lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_FRIENDSTATUS:
			if(userInfoEvent != null)
				userInfoEvent.OnAnyChatFriendStatus(wParam, lParam);
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_AUDIOPLAYCTRL:
			...
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_AUDIORECCTRL:
			if(mAudioHelper == null)
				break;
			if(wParam == 1)
			...
			break;
		case com.bairuitech.sscf.anychat.AnyChatDefine.WM_GV_VIDEOCAPCTRL:
         ...
         public void handleMessage(Message nMsg)
         {
             ...
             else if(type == HANDLE_TYPE_RECORD)
             {
            	 ...
            	 if(anychat.recordEvent != null) {
                 	 if((dwFlags & com.bairuitech.sscf.anychat.AnyChatDefine.ANYCHAT_RECORD_FLAGS_SNAPSHOT) == 0)
	...
	private void OnVideoDataCallBack(int userid, byte[] buf, int len, int width, int height)
	{
		...
		int degree = QueryUserStateInt(userid, com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_USERSTATE_VIDEOROTATION);
		int mirror = QueryUserStateInt(userid, com.bairuitech.sscf.anychat.AnyChatDefine.BRAC_USERSTATE_VIDEOMIRRORED);
	...
	// 数据加密、解密回调函数
	private int OnDataEncDecCallBack(int userid, int flags, byte[] buf, int len, com.bairuitech.sscf.anychat.AnyChatOutParam outParam)
	{
		if(encdecEvent != null)
