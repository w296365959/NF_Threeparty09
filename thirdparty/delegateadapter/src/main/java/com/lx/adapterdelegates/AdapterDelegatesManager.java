...
//      throw new NullPointerException("No AdapterDelegate added for ViewType " + viewType);
      Log.e("AdapterDelegatesManager", "No AdapterDelegate added for ViewType " + viewType);
      delegate = new EmptyAdapterDelegate();
    }
...
//          + viewHolder.getItemViewType());
      Log.e("AdapterDelegatesManager", "No delegate found for item at position = " + position + " for viewType = " + viewHolder.getItemViewType());
      delegate = new EmptyAdapterDelegate();
    }
...
//          + " for viewType = "
//          + viewHolder.getItemViewType());
      Log.e("AdapterDelegatesManager", "No delegate found for item " + " for viewType = " + viewHolder.getItemViewType());
      delegate = new EmptyAdapterDelegate();
    }
